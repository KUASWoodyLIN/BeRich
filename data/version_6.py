...
def load_data(stock_sql, load_dir=''):
    ...
    if os.path.isfile(x_train_file_1) and os.path.isfile(x_train_file_2) and os.path.isfile(x_train_file_3) and \
            os.path.isfile(x_train_file_4) and os.path.isfile(x_train_file_5) and os.path.isfile(y_train_file) and \
            os.path.isfile(x_val_file_1) and os.path.isfile(x_val_file_2) and os.path.isfile(x_val_file_3) and \
            os.path.isfile(x_val_file_4) and os.path.isfile(x_val_file_5) and os.path.isfile(y_val_file):
